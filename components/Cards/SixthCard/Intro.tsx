...
const Intro = (props: Props) => {
  ...
  return (
    <>
      <div
        className={`relative flex justify-center items-center flex-col h-[800px] text-[#233D4D]`}
      >
        {/*  */}
        <div
      ...
      {/*  */}
      <div className="flex flex-col justify-center items-center h-[800px] relative">
        {/*  */}
        <div
          className="absolute right-2 sm:h-[400px] md:h-[800px] z-0 bottom-0 transform -scale-x-100 "
          data-framer-background-image-wrapper="true"
        >
          <svg
            height="100%"
        ...
        <div className="w-[80%] z-50">
          <h2 className="sixthFont text-[60px]  my-10">About</h2>

          <div className="flex flex-wrap gap-8 sixthFont2 md:text-[30px] font-normal">
          ...
          <div className="flex flex-col gap-1 mt-7 md:text-[30px] font-normal sixthFont2">
