    ...
    <div className="h-[800px] relative">
      <div className="flex justify-center">
        <div className="w-[80%] z-50">
          <h2 className="ninthFont text-[60px]  mt-10 ">Services</h2>
      ...
      <div className="pt-6">
        ...
        >
          <SwiperSlide className="hover:scale-[1.02] transition-all ease-in-out duration-100">
            <div className="flex justify-center">
              <div
                className={`w-[350px] flex justify-center bg-[#FF4133] h-[450px] py-2 rounded-xl `}
              >
                <div className="flex flex-col justify-start items-center">
                  <p className="ninthFont2 text-[30px]  mt-2">Service 1</p>
                  ...
                  <button className="bg-[#290042] text-white px-6 py-5  rounded-md t-2 ">
                    Read more
                  </button>
                </div>
              </div>
