  ...
  return (
    <div className="flex justify-center items-center gap-4 lg:flex-row py-16 px-6 h-[500px] relative fourthFont2">
      ...
      <div className="flex flex-col gap-10 ">
        <button
          className="lg:w-96 w-80 h-16 rounded-lg bg-[#64B5F6] flex p-2 justify-center items-center hover:bg-[#242424] hover:border-2 hover:border-[#64B5F6] hover:text-white transition-all ease-in-out duration-150 relative font-medium tracking-widest"
        ...
        <button
          className="lg:w-96 w-80 h-16 rounded-lg bg-[#64B5F6] flex p-2 justify-center items-center hover:bg-[#242424] hover:border-2 hover:border-[#64B5F6] hover:text-white transition-all ease-in-out duration-150 relative"
