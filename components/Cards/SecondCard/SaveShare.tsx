  ...
  return (
    <div className="bg-black flex justify-center items-center gap-4 lg:flex-row py-16 px-6 h-[500px]">
      <div className="flex flex-col gap-10 ">
        <button
          className="lg:w-96 w-80 h-16 rounded-lg bg-white flex p-2 justify-center items-center hover:bg-[#242424] hover:border-2 hover:border-[#F9D254] hover:text-[#F9D254] transition-all ease-in-out duration-150 relative font-medium tracking-widest"
        ...
        <button
          className="lg:w-96 w-80 h-16 rounded-lg bg-white flex p-2 justify-center items-center hover:bg-[#242424] hover:border-2 hover:border-[#F9D254] hover:text-[#F9D254] transition-all ease-in-out duration-150 relative"
