  ...
  return (
    <div className="h-[800px]  flex flex-col gap-2 justify-center items-center relative">
      <div className="w-[80%] flex flex-col gap-4">
        <h2 className="eighthFont text-[60px]  my-10 z-50 text-[#16697A]">
          Business Hours
        </h2>
        {/*  */}
        ...
        {/*  */}
        <div className={`flex justify-center eighthFont2 text-xl z-50`}>
          <div className="flex justify-between border rounded-md  bg-[#EDE7E3] sm:w-[80%] w-[100%] sm:px-14 px-1 ">
            <p>Monday</p>
