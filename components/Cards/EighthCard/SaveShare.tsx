  ...
  return (
    <div className=" flex justify-center items-center gap-4 lg:flex-row py-16 px-6 h-[500px]">
      <div className="flex flex-col gap-10 ">
        <button
          className="lg:w-96 w-80 h-16 rounded-lg bg-[#16697A] flex p-2 justify-center items-center hover:bg-[#aeb0b1] hover:border-2 hover:border-white hover:text-white transition-all ease-in-out duration-150 relative font-medium tracking-widest text-white"
        ...
        <button
          className="lg:w-96 w-80 h-16 rounded-lg bg-[#16697A] flex p-2 justify-center items-center hover:bg-[#aeb0b1] hover:border-2 hover:border-white hover:text-white transition-all ease-in-out duration-150 relative text-white"
