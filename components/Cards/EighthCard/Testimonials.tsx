  ...
  return (
    <div className="h-[800px] relative">
      <div className="flex justify-center">
        <div className="w-[80%]">
          <h2 className="eighthFont text-[60px] text-[#16697A] mt-10 break-all">
            Testimonials
          </h2>
          <p className="eighthFont text-[30px] text-[#16697A] mb-10">
            (Swipe to explore)
          </p>
        </div>
      </div>
      ...
      <div className="pt-6">
        ...
        >
          ...
          <SwiperSlide className="hover:scale-[1.02] transition-all ease-in-out duration-100">
            <div className="flex justify-center">
              <div
                className={`w-[350px] flex justify-center bg-[#EDE7E3] text-black h-[450px] py-2 rounded-xl`}
              >
