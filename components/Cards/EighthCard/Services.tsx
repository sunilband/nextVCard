    ...
    <div className="h-[800px] relative">
      <div className="flex justify-center">
        <div className="w-[80%] z-50">
          <h2 className="eighthFont text-[60px]  mt-10 text-[#16697A]">
            Services
          </h2>
          <p className="eighthFont text-[30px]  mb-10 text-[#16697A]">
            (Swipe to explore)
          </p>
        </div>
      </div>
      ...
      <div className="pt-6">
        <Swiper
          ...
          className="h-[500px] w-[90%] flex justify-center eighthFont2"
        >
          <SwiperSlide className="hover:scale-[1.02] transition-all ease-in-out duration-100">
            <div className="flex justify-center">
              <div
                className={`w-[350px] flex justify-center bg-[#EDE7E3] h-[450px] py-2 rounded-xl`}
              >
                <div className="flex flex-col justify-start items-center">
                  <p className="eighthFont2 text-[30px] text-black mt-2">
                    Service 1
                  </p>
                  ...
                  <button className="bg-[#16697A] text-white px-6 py-5  rounded-md t-2 ">
                    Read more
                  </button>
                </div>
              </div>
            ...
            <div className="flex justify-center">
              ...
              >
                <div className="flex flex-col justify-start items-center">
                  ...
                  <button className="bg-[#16697A] text-white px-6 py-5 rounded-md mt-2">
                    Read more
                  </button>
                </div>
              </div>
